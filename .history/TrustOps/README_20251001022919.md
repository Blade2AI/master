...
- From terminal (PowerShell):
  - Run TrustOps/scripts/new_nhsbsa_proforma.ps1 with required parameters (Title, Org, RequesterName, RequesterRole, ContactEmail, Domain, Route, LawfulBasis, Purpose, Benefit, DateFrom, DateTo, GeogScope, DataCategory)
